...
def test_to_graph_should_return_title_without_language_tag() -> None:
    """It returns a title graph isomorphic to spec."""
    """It returns an identifier graph isomorphic to spec."""
    informationmodel = InformationModel()
    informationmodel.identifier = "http://example.com/informationmodels/1"
    informationmodel.title = {None: "Tittel 1"}
...
def test_to_graph_should_return_location_controlled_vocabulary() -> None:
    """It returns a location graph isomorphic to spec."""
...
def test_to_graph_should_return_has_format_skolemization(mocker: MockFixture) -> None:
...
def test_to_graph_should_return_status_as_uri() -> None:
    """It returns a information model graph isomorphic to spec."""
    """It returns an subject graph isomorphic to spec."""
...
def test_to_graph_should_return_conforms_to() -> None:
    """It returns an conforms_to graph isomorphic to spec."""
    informationmodel = InformationModel("http://example.com/informationmodels/1")
    standard = Standard("http://example.com/standards/1")
    informationmodel.conforms_to = standard
